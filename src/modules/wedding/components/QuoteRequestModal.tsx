...
const QuoteRequestModal = ({ isOpen, onClose, plannerName }: QuoteRequestModalProps) => {
      ...
      <div className="relative bg-card rounded-2xl p-8 w-full max-w-md animate-wedding-scale-in wedding-shadow">
        ...
        {submitted ? (
          <div className="text-center py-8 animate-wedding-fade-up">
            ...
            <h3 className="text-2xl font-bold" style={{ fontFamily: "'Playfair Display', serif" }}>Request Sent!</h3>
          ...
          <>
            ...
            {plannerName && <p className="text-sm text-muted-foreground mb-6">From {plannerName}</p>}
