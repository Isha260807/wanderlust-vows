...
const services = ['Full Planning', 'Decor & Design', 'Photography', 'Catering', 'Entertainment', 'Mehendi', 'Sangeet', 'Guest Management'];
  ...
  return (
    <div className="min-h-screen">
      <section className="pt-32 pb-8 px-4 text-center">
        ...
        <p className="text-muted-foreground mt-3 text-lg">Tell us about your vision</p>
      </section>
            ...
            <div key={s} className="flex items-center">
              <div
                className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-semibold transition-all duration-500 ${
                  step >= s ? 'wedding-gradient text-background' : 'bg-muted text-muted-foreground'
                }`}
              >
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {services.map(s => (
                      ...
                      >
                        {form.selectedServices.includes(s) && <Check className="w-4 h-4 inline mr-2" />}
                        {s}
                      </button>
                    ))}
                  </div>
