...
export interface Destination {
  ...
  name: string;
  location: string;
  category: 'Beach' | 'Heritage' | 'Hill' | 'Resort';
  image: string;
  description: string;
...
export const destinations: Destination[] = [
  {
    ...
    category: 'Beach',
    image: goaImg,
    description: 'Sun-kissed beaches, swaying palms, and golden sunsets create the perfect backdrop for a dreamy beach wedding. Goa offers a blend of Portuguese charm and tropical vibes.',
    startingPrice: 1500000,
    avgCost: '₹15L – ₹50L',
    bestSeason: 'Oct – Mar',
    venueCount: 12,
    venues: [
      { id: 'v1', name: 'Taj Exotica', type: 'Luxury Resort', capacity: 500, pricePerDay: 800000 },
      { id: 'v2', name: 'W Goa', type: 'Beachfront Hotel', capacity: 300, pricePerDay: 600000 },
      { id: 'v3', name: 'Cidade de Goa', type: 'Heritage Resort', capacity: 400, pricePerDay: 500000 },
    ],
    plannerIds: ['p1', 'p2', 'p5'],
  },
  {
    ...
    category: 'Heritage',
    image: jaipurImg,
    description: 'The Pink City offers majestic forts, ornate palaces, and regal hospitality. A Jaipur wedding is a celebration steeped in royal grandeur and timeless elegance.',
    startingPrice: 2000000,
    avgCost: '₹20L – ₹1Cr',
    bestSeason: 'Nov – Feb',
    venueCount: 18,
    venues: [
      { id: 'v4', name: 'Rambagh Palace', type: 'Palace', capacity: 800, pricePerDay: 1500000 },
      { id: 'v5', name: 'Samode Palace', type: 'Heritage Haveli', capacity: 400, pricePerDay: 900000 },
      { id: 'v6', name: 'Fairmont Jaipur', type: 'Luxury Hotel', capacity: 600, pricePerDay: 700000 },
    ],
    plannerIds: ['p1', 'p3', 'p6'],
  },
  {
    ...
    category: 'Heritage',
    image: udaipurImg,
    description: 'Known as the Venice of the East, Udaipur\'s shimmering lakes, white marble palaces, and Aravalli hills create a fairy-tale wedding setting.',
    startingPrice: 2500000,
    avgCost: '₹25L – ₹2Cr',
    bestSeason: 'Oct – Mar',
    venueCount: 15,
    venues: [
      { id: 'v7', name: 'Taj Lake Palace', type: 'Lake Palace', capacity: 250, pricePerDay: 2000000 },
      { id: 'v8', name: 'The Oberoi Udaivilas', type: 'Luxury Resort', capacity: 500, pricePerDay: 1800000 },
      { id: 'v9', name: 'Jagmandir Island', type: 'Island Palace', capacity: 400, pricePerDay: 1200000 },
    ],
    plannerIds: ['p2', 'p3', 'p4'],
  },
  {
    ...
    category: 'Resort',
    image: keralaImg,
    description: 'God\'s Own Country offers lush backwaters, tropical greenery, and serene beaches. A Kerala wedding is intimate, natural, and breathtakingly beautiful.',
    startingPrice: 1200000,
    avgCost: '₹12L – ₹40L',
    bestSeason: 'Sep – Mar',
    venueCount: 10,
    venues: [
      { id: 'v10', name: 'Kumarakom Lake Resort', type: 'Lake Resort', capacity: 300, pricePerDay: 500000 },
      { id: 'v11', name: 'Taj Bekal', type: 'Beach Resort', capacity: 400, pricePerDay: 600000 },
    ],
    plannerIds: ['p4', 'p5', 'p7'],
  },
  {
    ...
    category: 'Hill',
    image: rishikeshImg,
    description: 'Nestled in the Himalayan foothills by the sacred Ganges, Rishikesh offers a spiritual and scenic escape for couples seeking a unique, nature-inspired wedding.',
    startingPrice: 800000,
    avgCost: '₹8L – ₹25L',
    bestSeason: 'Oct – Apr',
    venueCount: 6,
    venues: [
      { id: 'v12', name: 'Aloha on the Ganges', type: 'Riverside Resort', capacity: 200, pricePerDay: 300000 },
      { id: 'v13', name: 'Ananda in the Himalayas', type: 'Luxury Spa Resort', capacity: 150, pricePerDay: 700000 },
    ],
    plannerIds: ['p6', 'p7', 'p8'],
  },
  {
    ...
    category: 'Resort',
    image: jimcorbettImg,
    description: 'Surrounded by dense forests and the Ramganga river, Jim Corbett offers a magical wilderness wedding with luxury jungle resorts and starlit evenings.',
    startingPrice: 1000000,
    avgCost: '₹10L – ₹35L',
    bestSeason: 'Oct – Mar',
    venueCount: 5,
    venues: [
      { id: 'v14', name: 'The Solluna Resort', type: 'Forest Resort', capacity: 250, pricePerDay: 400000 },
      { id: 'v15', name: 'Namah Resort', type: 'Luxury Resort', capacity: 300, pricePerDay: 500000 },
    ],
    plannerIds: ['p1', 'p8', 'p4'],
  },
];
...
export const planners: Planner[] = [
  {
    ...
    cities: ['Jaipur', 'Goa', 'Jim Corbett'], specialties: ['Royal Weddings', 'Destination Events'],
    ...
    portfolioImages: [], services: ['Full Planning', 'Decor', 'Vendor Management', 'Guest Management'],
    packages: [
  ...
  },
  {
    ...
    cities: ['Udaipur', 'Goa'], specialties: ['Luxury Weddings', 'Beach Ceremonies'],
    ...
    portfolioImages: [], services: ['Full Planning', 'Decor', 'Photography', 'Catering'],
    packages: [
  ...
  },
  {
    ...
    cities: ['Jaipur', 'Udaipur', 'Delhi'], specialties: ['Heritage Weddings', 'Multi-day Events'],
    ...
    portfolioImages: [], services: ['Full Planning', 'Decor', 'Entertainment', 'Logistics'],
    packages: [
  ...
  },
  {
    ...
    cities: ['Kerala', 'Udaipur', 'Jim Corbett'], specialties: ['Eco Weddings', 'Intimate Ceremonies'],
    ...
    portfolioImages: [], services: ['Planning', 'Sustainable Decor', 'Local Vendor Sourcing'],
    packages: [
  ...
  },
  {
    ...
    cities: ['Goa', 'Kerala'], specialties: ['Beach Weddings', 'Sunset Ceremonies'],
    ...
    portfolioImages: [], services: ['Full Planning', 'Beach Decor', 'Photography', 'Entertainment'],
    packages: [
  ...
  },
  {
    ...
    cities: ['Jaipur', 'Rishikesh'], specialties: ['Grand Celebrations', 'Themed Weddings'],
    ...
    portfolioImages: [], services: ['Full Planning', 'Theme Design', 'Decor', 'Entertainment'],
    packages: [
  ...
  },
  {
    ...
    cities: ['Kerala', 'Rishikesh'], specialties: ['Spiritual Weddings', 'Nature Ceremonies'],
    ...
    portfolioImages: [], services: ['Planning', 'Nature Decor', 'Rituals Coordination'],
    packages: [
  ...
  },
  {
    ...
    cities: ['Rishikesh', 'Jim Corbett', 'Mussoorie'], specialties: ['Mountain Weddings', 'Adventure Ceremonies'],
    ...
    portfolioImages: [], services: ['Full Planning', 'Adventure Activities', 'Decor', 'Photography'],
    packages: [
...
export const testimonials: Testimonial[] = [
  { name: 'Anita & Rohit Malhotra', location: 'Jaipur Wedding', text: 'Our palace wedding was beyond anything we imagined. Every flower, every light — pure magic.', rating: 5 },
  { name: 'Sneha & Vikram Reddy', location: 'Udaipur Wedding', text: 'The lakeside ceremony at sunset was the most beautiful moment of our lives.', rating: 5 },
  { name: 'Tara & Jay Khanna', location: 'Goa Wedding', text: 'Dancing barefoot on the beach under fairy lights — exactly the wedding we dreamed of.', rating: 5 },
  { name: 'Nisha & Rahul Verma', location: 'Kerala Wedding', text: 'The backwater ceremony was intimate, serene, and absolutely unforgettable.', rating: 5 },
  { name: 'Zara & Nikhil Thakur', location: 'Jim Corbett Wedding', text: 'A jungle wedding under the stars — our guests are still talking about it!', rating: 5 },
];
...
export const saveEnquiry = (data: Record<string, unknown>) => {
...
export const getEnquiries = (): Record<string, unknown>[] => {
  try {
    return JSON.parse(localStorage.getItem('weddingEnquiries') || '[]');
  } catch { return []; }
};

export const saveFavourite = (id: string) => {
